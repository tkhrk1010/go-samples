...
func (x *ProtoMsg) GetState() string {
	if x != nil {
		return x.State
	}
	return ""
...
func (x *ProtoMsg) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
type Message struct {
	...
	ProtoMsg *ProtoMsg `protobuf:"bytes,1,opt,name=proto_msg,json=protoMsg,proto3" json:"proto_msg,omitempty"`
}
...
func (x *Message) GetProtoMsg() *ProtoMsg {
	if x != nil {
		return x.ProtoMsg
	}
	return nil
...
func (x *Snapshot) GetProtoMsg() *ProtoMsg {
	if x != nil {
		return x.ProtoMsg
	}
	return nil
...
var file_protos_proto_rawDesc = []byte{
	...
	,
...
var file_protos_proto_goTypes = []interface{}{
	(*ProtoMsg)(nil), // 0: proto.ProtoMsg
	(*Message)(nil),  // 1: proto.Message
	(*Snapshot)(nil), // 2: proto.Snapshot
}
var file_protos_proto_depIdxs = []int32{
	0, // 0: proto.Message.proto_msg:type_name -> proto.ProtoMsg
	0, // 1: proto.Snapshot.proto_msg:type_name -> proto.ProtoMsg
